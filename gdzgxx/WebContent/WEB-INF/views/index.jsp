		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" id="page-sidebar-menu">
					...
					<li class=""><a href="./rest/notice/list"> <i class="fa fa-bell"></i><span
							class="title"> 通知公告 <span id="newNotice" class="noticeNew">&emsp;新！</span></span>
					</a></li>
