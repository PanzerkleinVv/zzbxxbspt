	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="userName" id="userName" size="25" value="" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="姓名" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="userPsw" id="userPsw" size="25" value="" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="身份证号" />
			</div>
		</div>
